...
* Contributions by Emre Yolcu (@emreyolcu on GitHub):
  ...
  * Introduced a mode registration system for persisting and restoring custom major modes across EasySession sessions. Users can register and unregister modes using `easysession-register-major-mode` and `easysession-unregister-major-mode`.
